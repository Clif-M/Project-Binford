...
@JsonDeserialize(builder = CreateUserRoleRequest.Builder.class)
public class CreateUserRoleRequest {
    ...
    private CreateUserRoleRequest(String userEmail, String orgId, String jobRole, String displayName, String roleStatus) {
    ...
    public static class Builder{
        ...
        public CreateUserRoleRequest build() {
            return new CreateUserRoleRequest(userEmail,orgId,jobRole,displayName,roleStatus);
        }
    }
}
